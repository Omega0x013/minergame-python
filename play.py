...
fnt = pygame.font.Font('/home/xander/Documents/openevening/minergame/font.otf', 20)
...
def mainloop():
    ...
    while not done:
        ...
        screen.blit(fnt.render('$' + str(gold), True, (255, 255, 0)), (0, 0))
        ui_y = 30
...
pygame.display.set_icon(pygame.image.load('/home/xander/Documents/openevening/minergame/icon.png'))
mainloop()
